...
<ui version="4.0">
 ...
 <widget class="QMainWindow" name="MainWindow">
  ...
  <property name="styleSheet">
   <string notr="true">QPushButton, QToolButton, QCommandLinkButton{
    padding: 0 5px 0 5px;
    border-style: solid;
...
QScrollBar::right-arrow:horizontal {
  ...
  <widget class="QWidget" name="centralwidget">
   <widget class="QGraphicsView" name="imagen_luz">
    <property name="geometry">
     <rect>
      <x>200</x>
      <y>160</y>
   ...
   <widget class="QGraphicsView" name="imagen_persiana">
    <property name="geometry">
     <rect>
      <x>200</x>
      <y>410</y>
   ...
   <widget class="QLabel" name="label2">
    ...
    <property name="text">
     <string>Mensaje luz:</string>
    </property>
    <property name="alignment">
     <set>Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter</set>
    </property>
   </widget>
   <widget class="QLabel" name="persiana">
    <property name="geometry">
     <rect>
      <x>200</x>
      <y>350</y>
   ...
   <widget class="QLabel" name="label3">
    ...
    <property name="text">
     <string>Mensaje persiana:</string>
    </property>
    <property name="alignment">
     <set>Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter</set>
    </property>
   ...
   <widget class="QLabel" name="label">
    ...
    <property name="text">
     <string>Actuadores Zona 1</string>
    </property>
    <property name="alignment">
     <set>Qt::AlignCenter</set>
    </property>
   </widget>
   <widget class="QLabel" name="luz">
    <property name="geometry">
     <rect>
      <x>200</x>
      <y>90</y>
